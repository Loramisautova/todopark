                                ...
                                <div className={styles.dueDate}>
                                    {
                                        ...
                                        <Button
                                            ...
                                            icon={<CalendarOutlined className={styles.icon} onClick={() => handleCalendarClick(true)} />}
                                        />
                                    }
                                    {
                                        dueDate && <div className={styles.title}>{formatDate(dueDate, DATE_SHORT_REVERTED_FORMAT)}</div>
                                    }
                                </div>
                            </CalendarPopover>
                        </div>
